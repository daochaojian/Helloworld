...
/* eslint-disable */
  fetchData() {
    fetch(`https://www.v2ex.com/api/topics/show.json?node_name=jobs`, {
      method: 'GET',
      headers: {
    ...
    fetch(`https://www.v2ex.com/api/topics/show.json?node_name=cv`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      fetch(`https://www.v2ex.com/api/topics/show.json?node_name=career`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      fetch(`https://www.v2ex.com/api/topics/show.json?node_name=outsourcing`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
